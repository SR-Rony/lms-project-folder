...
export function Logo({ className, showTagline = false, compact = false }: LogoProps) {
  ...
  return (
    <Link href="/" className={cn("group flex items-center gap-2.5 lg:gap-3", className)}>
      <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-gradient-brand text-primary-foreground shadow-[0_8px_20px_-8px_rgba(235,32,38,0.5)] transition-transform group-hover:scale-105 lg:h-10 lg:w-10 lg:rounded-2xl">
